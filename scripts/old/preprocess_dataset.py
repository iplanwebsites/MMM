...
"""
Old data preprocessing script, chunking and augmenting files.

This scripts allows to load music files on the fly by chunking and augmenting them.
It however multiply the total number of files of the dataset, which can reach up to
several million, which may be not supported on some HPCs.
"""
