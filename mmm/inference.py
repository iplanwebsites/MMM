...
def generate_infilling(
    ...
    end_time = time.time()
    print("[INFO::generate_infilling] Time spent for converting score to tokens: ", end_time - start_time)
    ...
    end_time = time.time()
    print("[INFO::generate_infilling] Time spent for converting tokens to score: ", end_time - start_time)
    return result
...
def infill_bars(
    ...
    for subset_bars_to_infill in inference_config.bars_to_generate[track_idx]:
        ...
        end_time = time.time()
        print("[INFO::infill_bars] Time spent for creating input sequence: ", end_time - start_time)
        ...
        end_time = time.time()
        print("[INFO::infill_bars] Time spend for reconstructing the sequence: ", end_time - start_time)
